...
<head>
    ...
    <style>
        ...
        nav ul li a {
            ...
            transition: color 0.3s; /* Geçiş efekti ekliyoruz */
        }
    ...
    <section class="card-container">
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/BilimKurgu1.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 1 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/BilimKurgu2.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 2 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/BilimKurgu3.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 3 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/BilimKurgu4.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 4 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/BilimKurgu8.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 8 Arkası</p>
                </div>
            </div>
