    ...
    <section class="card-container">
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/Komedi1.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 1 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/Komedi2.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 2 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/Komedi3.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 3 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/Komedi4.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 4 Arkası</p>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-front" style="background-image: url('img/Komedi5.jpeg');"></div>
                <div class="card-back">
                    <p>Kart 5 Arkası</p>
                </div>
            </div>
